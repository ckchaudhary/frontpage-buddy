...
class GroupExtension extends \BP_Group_Extension {
	...
	public function settings_screen( $group_id = null ) {
		\RecycleBin\FrontPageBuddy\load_template( frontpage_buddy()->bp_groups()->get_component_type() . '/manage' );
	}
	...
	public function custom_group_boxes() {
		frontpage_buddy()->bp_groups()->output_frontpage_content( bp_get_current_group_id() );
	}
}
