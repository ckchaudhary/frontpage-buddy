<?php
/**
 * Overwrite BP Nouveau Default user's front template.
 * The only change is the addition of the following single line of code:
 * do_action( 'members_custom_group_boxes' );
 *
...
<div class="member-front-page">
	...
	<?php do_action( 'members_custom_group_boxes' ); ?>
